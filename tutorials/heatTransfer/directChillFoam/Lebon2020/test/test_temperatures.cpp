...
{
    TemperatureVectors(string casename, string end_time = "80", double tolerance = 3.0)
        : casename{casename},
          end_time{end_time},
          tolerance{tolerance}
    {
...
BOOST_FIXTURE_TEST_SUITE(CheckIfTemperaturesMatchExpectedValues, F);
    ...
    BOOST_AUTO_TEST_CASE(CheckIfx0mmTemperaturesMatchExpectedValues)
    {
    ...
    BOOST_AUTO_TEST_CASE(CheckIfx28mmTemperaturesMatchExpectedValues)
    {
        string casename{"x28mm"};
        TemperatureVectors temperatures{casename};
        temperatures.boost_check();
    }

    BOOST_AUTO_TEST_CASE(CheckIfx44mmTemperaturesMatchExpectedValues)
    {
        string casename{"x44mm"};
        TemperatureVectors temperatures{casename};
        temperatures.boost_check();
    }

    BOOST_AUTO_TEST_CASE(CheckIfx75mmTemperaturesMatchExpectedValues)
    {
        string casename{"x75mm"};
        TemperatureVectors temperatures{casename};
        temperatures.boost_check();
    }
