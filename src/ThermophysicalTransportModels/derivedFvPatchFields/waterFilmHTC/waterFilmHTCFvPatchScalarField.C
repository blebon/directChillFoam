...
#include "waterFilmHTCFvPatchScalarField.H"
#include "volFields.H"
...
namespace Foam
{
    ...
    NamedEnum
    <
        waterFilmHTCFvPatchScalarField::operationMode,
        3
    >::names[] =
    {
        "power",
...
<
    Foam::waterFilmHTCFvPatchScalarField::operationMode,
    3
> Foam::waterFilmHTCFvPatchScalarField::operationModeNames;
    ...
    kappaLayers_()
{
    switch (mode_)
    {
        ...
        {
            htc_ = Function1<scalar>::New("htc", dict);
...
waterFilmHTCFvPatchScalarField
(
    const waterFilmHTCFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
waterFilmHTCFvPatchScalarField
(
    const waterFilmHTCFvPatchScalarField& tppsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void Foam::waterFilmHTCFvPatchScalarField::autoMap
(
...
void Foam::waterFilmHTCFvPatchScalarField::rmap
(
...
)
{
    ...
    const waterFilmHTCFvPatchScalarField& tiptf =
        refCast<const waterFilmHTCFvPatchScalarField>(ptf);
...
void Foam::waterFilmHTCFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    switch (mode_)
    {
        ...
        case variableHeatTransferCoeff:
        {
            ...
            T_ = patch().lookupPatchField<volScalarField, scalar>("T");
            forAll (h_, i)
            {
                h_[i] = htc_->value(T_[i]);
            }
...
void Foam::waterFilmHTCFvPatchScalarField::write
(
    Ostream& os
) const
{
